...
// Auth information
global.pairNumber = "260974774036";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["260974774036"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["260974774036"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["260974774036"];
global.OwnerName = process.env.OWNER_NAME || "Kondwani Creates";
...
global.location = process.env.LOCATION || "Lusaka, Zambia";
